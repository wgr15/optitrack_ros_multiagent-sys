...
#        self.actor_ca_optimizer.step()
    ...
    def load_models(self):
        if self.train_type == 1:
            ...
            self.actor_ca.load_state_dict(torch.load('/home/wanggr/catkin_ws/src/algorithm/Pytorch_DRL/HNRN/models/best_ca_actor.model'))
            self.critic_ca.load_state_dict(torch.load('/home/wanggr/catkin_ws/src/algorithm/Pytorch_DRL/HNRN/models/best_ca_critic.model'))
